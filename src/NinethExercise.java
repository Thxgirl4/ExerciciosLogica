...
public class NinethExercise {
    public static void main(String[] args) {
        ...
        if(imc <= 18.5 ){
        System.out.println("Voce está abaixo do peso!" + " seu imc eh: " + imc);
    } else if(imc >= 18.6 && imc <= 24.9){
        System.out.println("Voce esta em seu peso ideal, parabens!" + "seu imc eh: " + imc);
            ...
            System.out.println("Obesidade grau III (mórbida)! seu imc é: " + imc);
        }
    }
}
